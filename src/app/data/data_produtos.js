const espaguete = "/espaguete.jpg";
const lasanha = "/lasanha.jpg";
const ravioli = "/ravioli.jpg";
const capeletti = "/capeletti.jpg";
const nhoque = "/nhoque.jpg";
const bruschetta = "/bruschetta.jpg";
const carpaccio = "/carpaccio.jpg";
const paella = "/paella.jpg";
const ebiSpicy = "/ebi-spicy.jpg";
const aligot = "/aligot.jpg";
const fileMignon = "/file-mignon.jpg";
const picanha = "/picanha.png";
const bifeAncho = "/bife-ancho.jpg";
const tomahwankSteak = "/tomahawk-steak.jpg";
const primeRib = "/prime-rib.jpg";
const tiramisu = "/tiramisu.jpg";
const cheesecake = "/cheesecake.jpg";
const banoffee = "/banoffee.png";
const milFolhas = "/mil-folhas.jpg";
const pudim = "/pudim.jpg";
const cerveja = "/cerveja.jpg";
const refrigerante = "/refrigerante.jpg";
const suco = "/suco.jpg";
const whiskey = "/whiskey.jpg";
const agua = "/agua.jpg";
const saladaCeasar = "/salada-ceasar.jpg";
const saladaCaprese = "/salada-caprese.jpg";
const saladaWaldorf = "/salada-waldorf.jpg";
const saladaGrega = "/salada-grega.jpg";
const saladaNicoise = "/salada-nicoise.jpg";
